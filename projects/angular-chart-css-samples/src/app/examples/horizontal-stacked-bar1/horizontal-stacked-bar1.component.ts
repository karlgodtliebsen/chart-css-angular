...
@Component({
  selector: 'app-horizontal-stacked-bar1',
  templateUrl: './horizontal-stacked-bar1.component.html',
  styleUrls: ['./horizontal-stacked-bar1.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class HorizontalStackedBar1Component implements OnInit {
